...
**Owner**: ARCH.00  
**Last updated**: 2026-08-31 (`TASK-00224` — added the Android client design: module
...
### Android client modules (`TASK-00224` design; `vw_jni_bridge`/`VwClient` implemented `TASK-00225`/`00226`; core browse/login/transfer UI done `TASK-00229`; vault support done `TASK-00230` — sharing/account-self-service UI still TASK-00231/00232)
...
| UI (Views) | `android/app/src/main/java/.../ui/` | MOB.10 | Kotlin | File browser (breadcrumb + CRUD, plus a vault mode — `TASK-00230`), login/2FA challenge, transfer queue, vault create/unlock/browse (`VaultActivity`) — all done (`TASK-00229`/`00230`; full 2FA login success blocked on the server-side bug filed as `TASK-00238`, not on this UI). Account/profile self-service and sharing/links UI still pending (`TASK-00231`/`00232`). |
