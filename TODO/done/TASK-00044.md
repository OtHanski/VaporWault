...
version bump) before TASK-00045 and TASK-00046 can begin.
...
"max 3 requests per email per hour" but SRV.01's implementation (TASK-00046)
...
rather than "3 per hour". TASK-00044 body should be updated in a follow-up
