...
protocol stack. These complement the existing unit tests (TASK-00012) which exercise
...
- `tests/integration/CMakeLists.txt` — Python integration test registered as CTest
  ...
  Passes `--admin-cli $<TARGET_FILE:vapourwault-server-cli>` (TASK-00040 dependency).
...
**[BLOCKING] TASK-00038 — tests/integration/run_integration.py, IT-8 block (~line 399)**
...
**[ADVISORY] TASK-00038 — tests/integration/run_integration.py, admin_cmd call (~line 291)**
...
SRV.01 [2026-07-12]: Integration test updated for AF_UNIX admin socket (see TASK-00040
