...
- These are already in the API sketch in TASK-00048; implement them as part of
...
ARCH.00 [2026-07-13]: CQR.08 signed off. No blocking findings. TASK-00050 done.
TASK-00053 (cluster status GUI view) is unblocked.
