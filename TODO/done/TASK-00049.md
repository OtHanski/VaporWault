...
- `cluster_port` (uint16, default 9010) — already needed from TASK-00048
...
self-documenting. Acceptable to add in TASK-00050 or a separate cleanup task.
...
vw_oplog_append_raw) is tracked for TASK-00050. Closing task.
