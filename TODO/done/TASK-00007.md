...
created:     2026-06-23
priority:    high
depends_on:  [TASK-00001, TASK-00004]
blocks:      [TASK-00008, TASK-00030, TASK-00035]
...
- QA.06 crash-injection tests (CJ-1 through CJ-5 from TASK-00012) must pass before done
...
uncommitted entries**
The TASK-00007 acceptance criteria specify a `confirmed` byte in the entry format and a
...
SRV.01 [2026-07-06]: Two-phase commit implemented per ARCH.00 direction (fold into TASK-00007).
...
TASK-00007 can close and before TASK-00008 (vw_store) picks up.
...
SEC.07 and CQR.08 before TASK-00007 can close.
...
Additionally, `vw_smtp.c` from_addr SMTP injection (SEC-ADV from TASK-00006) fixed: the
...
Note: the TASK-00007 acceptance criteria list vw_oplog_confirm and vw_oplog_seek which are not
...
TASK-00007 → done. TASK-00008 (vw_store) is now unblocked.
