...
created:     2026-08-25
priority:    normal
depends_on:  [TASK-00207, TASK-00208, TASK-00209, TASK-00210, TASK-00211]
blocks:      [TASK-00213]
review_by:   [CQR.08]
tags:        [docs]
---
...
- `docs/DEPLOYMENT.md`: new section documenting the `notify.*`
  `vapourwaultd.conf` keys from `TASK-00208` (what each admin category
...
- `docs/CLIENT_GETTING_STARTED.md`: a short, plain-language note on the
  user-facing notification toggles (`TASK-00209`/`00210`/`00211`) — what each
...
- `docs/CLIENT_GETTING_STARTED.md`: new "Email notifications" section
  ...
  language, a table naming the same four categories `TASK-00210`'s GUI
...
- **A non-technical end user reading `docs/CLIENT_GETTING_STARTED.md` can
  ...
  matching `TASK-00210`'s real GUI label) and describes each category in
...
- The `CLIENT_GETTING_STARTED.md` category descriptions match `TASK-00210`'s
  actual GUI checkbox labels and `TASK-00211`'s web frontend labels, not
