...
Tagged `security-sensitive` for the same reason TASK-00114 is: writing tests
...
Server-side half of the testing-gap ask; see TASK-00114 for the client-side
...
TASK-00114's `VW_SYNC_TESTABLE` pattern exactly — `VW_FH_TESTABLE`, gated on
...
TASK-00114 since both diffs are closely related and use the same pattern.

SEC.07 + CQR.08 [2026-08-04]: Reviewed jointly with TASK-00114. **No
