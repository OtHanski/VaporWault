...
per the payload spec in `docs/PROTOCOL.md` (published by TASK-00044).
...
The GC thread (TASK-00042) should periodically expire unused, expired invites
(mark them used or delete them). Add this as an additional pass in `vw_gc.c`
after TASK-00042 is complete.
...
available to non-admins. Depends on TASK-00044 for payload format.
