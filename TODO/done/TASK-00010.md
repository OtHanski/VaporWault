...
created:     2026-06-23
priority:    high
depends_on:  [TASK-00005]
blocks:      [TASK-00009, TASK-00033, TASK-00034]
...
BLOCKING-2 — AUTH PLAIN not implemented (acceptance criteria gap):
  TASK-00010's acceptance criteria explicitly states "AUTH LOGIN and AUTH PLAIN both
...
BLOCKING-3 — No per-command timeout (acceptance criteria gap):
  TASK-00010's acceptance criteria requires "Timeout: 30 seconds per SMTP command".
