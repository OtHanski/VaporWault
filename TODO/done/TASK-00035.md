...
interface target so GUI.03 can start TASK-00036 with a working `add_subdirectory` import.
...
ARCH.00 [2026-07-11]: This task is a hard blocker for TASK-00036 (GUI.03). BLD.05 must
