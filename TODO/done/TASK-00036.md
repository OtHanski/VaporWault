...
created:     2026-07-11
priority:    normal
depends_on:  [TASK-00031, TASK-00035]
blocks:      []
review_by:   [CQR.08]
...
target_link_libraries(vapourwault-gui PRIVATE
    vw_gui_backend     # Dear ImGui + SDL2 + OpenGL3 (from TASK-00035)
...
socket code lives here. GUI.03 blocks on TASK-00035 (Dear ImGui vendored and buildable)
