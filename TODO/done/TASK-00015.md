...
all. SRV.01 and CLI.02 cannot implement TASK-00011 (auth wire integration) without
hand-rolling their own serialisation, which would produce diverging implementations.
This task blocks TASK-00011 and must be done by PRT.04 before TASK-00011 is picked up.
...
ARCH.00 [2026-07-06]: Items 1-3 are BLOCKING for TASK-00011 (auth wire integration).
PRT.04 must implement all five encode/decode pairs and the error helpers before SRV.01
and CLI.02 pick up TASK-00011. The two empty payload structs must also be fixed — they
...
CQR.08 sign-off: no blocking findings BEYOND what SEC.07 identified. TASK-00015 cannot
...
raising with ARCH.00 for a wire-format decision before TASK-00011.
...
No remaining blocking findings from SEC.07. TASK-00015 may close once CQR.08 has signed off.
...
No remaining blocking findings. TASK-00015 may proceed to `done` after ARCH.00 confirmation.

ARCH.00 [2026-07-06]: Closing TASK-00015. All three blocking findings (SEC.07+CQR.08 BLOCKING-A/B/C)
...
protocol-revision task (to be created by ARCH.00 before TASK-00011 picks up). TASK-00015 is DONE.
