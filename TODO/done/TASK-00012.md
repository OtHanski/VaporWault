...
- Crash-injection (see §3 below) — these tests live here and satisfy the TASK-00007 gate
...
### 3. Crash-injection tests for vw_oplog (TASK-00007 gate)

Required for TASK-00007 to move to done. Implemented as part of the vw_oplog unit test
...
ARCH.00 [2026-07-06]: This task is the primary gate for TASK-00007 (vw_oplog) reaching
done status. The crash-injection tests (CJ-1 through CJ-5) must pass and QA.06 must
append a sign-off note to TASK-00007.md before ARCH.00 closes that task.
...
Once CJ-1 through CJ-5 pass in CI, QA.06 will append a sign-off note to TASK-00007.md
...
Remaining items (deferred):
- §4: Integration test scaffold (process-spawn framework) — blocked on TASK-00033 (server
...
- §6: CI YAML — tracked separately in TASK-00034 (BLD.05).
...
outside TASK-00012's scope; they are tracked in TASK-00033 and TASK-00034. CQR.08 to sign off
...
Sign-off: CQR.08 approves TASK-00012 for done.

ARCH.00 [2026-07-12]: TASK-00012 done. Phase 3 test coverage complete.
