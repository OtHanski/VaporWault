...
created:     2026-07-21
priority:    normal
depends_on:  [TASK-00081]
blocks:      []
review_by:   [CQR.08]
tags:        [ci, release, advisory]
---

CQR.08 and QA.06's review of `TASK-00081` (the new `.github/workflows/release.yml`
...
ARCH.00 [2026-07-21]: Split out from TASK-00081's review findings (CQR.08 findings
...
`TASK-00081`'s history, "Dear ImGui has no CMakeLists.txt"), which is the
