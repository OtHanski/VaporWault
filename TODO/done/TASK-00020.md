...
This is a blocking finding (CQR.08-B-2) against TASK-00011.  TASK-00011 cannot move to
...
CQR.08 [2026-07-07]: Created from review of TASK-00011.  The server already passes
`user_id` to `build_and_send_auth_ok`; the gap is in the protocol encoding and client
parsing only.  Scope is small — same files as TASK-00011.
...
SEC.07 clears the security review for TASK-00020. ✓
...
CQR.08-B-2 is cleared.  TASK-00011 may now proceed to `done`. ✓
