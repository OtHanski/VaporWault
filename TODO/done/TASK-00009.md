...
created:     2026-06-23
priority:    high
depends_on:  [TASK-00003, TASK-00008, TASK-00017]
blocks:      [TASK-00010, TASK-00012]
...
ARCH.00 [2026-07-06]: Architecture review added TASK-00017 as a blocking prerequisite.
vw_auth_provider's email OTP implementation calls vw_smtp_send with cfg->from_addr and
the user's email address as to_addr. TASK-00017 fixes a CRLF injection in from_addr
...
TASK-00009 has no remaining SEC.07 blocking findings. May close once CQR.08 signs off.
...
TASK-00009 has no remaining CQR.08 blocking findings.

ARCH.00 [2026-07-07]: Closing TASK-00009. SEC.07 and CQR.08 both signed off with no blocking
findings; both advisories (otp_hash cleanup, header doc) were fixed by PRT.04 during review.

TASK-00011 (auth wire) is now unblocked — all four dependencies (TASK-00009 ✓, TASK-00015 ✓,
TASK-00016 ✓, TASK-00018 ✓) are done. SRV.01 and CLI.02 may pick up TASK-00011.
TASK-00009 is DONE.
