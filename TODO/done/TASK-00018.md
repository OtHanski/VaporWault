...
created:     2026-07-06
priority:    high
depends_on:  [TASK-00015]
blocks:      [TASK-00011]
review_by:   [CQR.08, SEC.07]
tags:        [protocol, phase-1, security-sensitive]
---

SEC.07 flagged during TASK-00015 review that `vw_payload_auth_fail_t.lockout_remaining_secs`
...
before TASK-00011 (auth wire integration) picks up so that SRV.01 and CLI.02 implement
...
ARCH.00 [2026-07-06]: Created from SEC.07 ADVISORY raised during TASK-00015 review.
The u8 field was accepted in TASK-00015 as advisory; it is upgraded to a blocking gate
for TASK-00011 because SRV.01 and CLI.02 must implement a consistent wire format.
A 600-second lockout window is required; u8 cannot represent it correctly.
PRT.04 owns this change; SRV.01 and CLI.02 must not start TASK-00011 until this task
...
SEC.07 review required (security-sensitive tag). No CQR.08 blocking findings; TASK-00018
...
ARCH.00 [2026-07-06]: Closing TASK-00018. Both reviewers confirmed no blocking findings.
Protocol v2 is now the current version. TASK-00011 dependency on TASK-00018 is satisfied.
TASK-00018 is DONE.
