...
priority:    high
depends_on:  []
blocks:      [TASK-00030, TASK-00031]
review_by:   [CQR.08]
tags:        [client, ipc, protocol, phase-3]
---

Implement `src/client/vw_ipc.{h,c}` — the IPC protocol used between the
VaporWault daemon (TASK-00030) and its thin clients (CLI: TASK-00031, GUI: Phase 7).
...
ARCH.00 [2026-07-11]: Task closed. TASK-00030 and TASK-00031 are unblocked.
