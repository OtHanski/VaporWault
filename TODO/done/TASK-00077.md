...
CQR.08 noted while reviewing TASK-00073: `src/server/vw_admin.c` uses plain
...
This is pre-existing (predates TASK-00073's change) and not a regression —
...
TASK-00073's review. Low priority — hardening, not a functional bug.
