...
created:     2026-08-04
priority:    normal
depends_on:  [TASK-00114, TASK-00115, TASK-00116, TASK-00117, TASK-00118, TASK-00119]
blocks:      []
review_by:   [CQR.08]
tags:        [docs, gui]
---
...
only after TASK-00114 through TASK-00119 close, since several of them (the
...
- **Part 1 — audit the existing `docs/TUTORIAL.md`** for accuracy against
  ...
  TASK-00117/00118/00119 didn't change server-admin-facing behavior — this is a
...
as an explicitly-last task gated on TASK-00114 through TASK-00119 closing
...
(`TASK-00092`) that the tutorial's sample output didn't show. Fixed, with a
one-line explanation of what `full`/`-`/a capability list means. Everything
else checked out — confirms this task's own prediction that TASK-00117/00118/00119
...
task):** `TASK-00126` — the GUI's "Conflict" popup modal is dead code
