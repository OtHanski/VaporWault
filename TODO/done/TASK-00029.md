...
(Phase 2 file ops) and `vw_cache` (TASK-00026). It does not talk to the server
...
ARCH.00 [2026-07-11]: TASK-00029 review. Blocks TASK-00030.
...
Sign-off: SEC.07 approves TASK-00029 for done (blocking finding resolved).
...
Sign-off: CQR.08 approves TASK-00029 for done.
