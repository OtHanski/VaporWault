...
mandatory — SEC.07 will block this task if it is absent. Depends on TASK-00044
...
- AUTH_RECOVER_FAIL reason always 0 (per SEC.07 requirement from TASK-00044).
...
rate, but a GC pass should be added (TASK-00043 or a dedicated follow-up). Not
