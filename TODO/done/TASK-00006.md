...
created:     2026-06-23
priority:    critical
depends_on:  [TASK-00002, TASK-00005]
blocks:      [TASK-00012, TASK-00021]
...
ARCH.00 [2026-06-23]: Depends on TASK-00002 (PROTOCOL.md) being in draft form; PRT.04
may proceed once the message types and payload layouts are documented, even if SEC.07
review of TASK-00002 is still pending.
...
ARCH.00 [2026-07-06]: Three access-control security advisories from the PROTOCOL.md review (TASK-00002) are recorded here as blocking constraints on any future task that implements the chunk upload/download server endpoints (vw_storage_files, server-side CHUNK_QUERY/CHUNK_UPLOAD/CHUNK_DOWNLOAD handlers). These constraints MUST appear as blocking requirements in those implementation tasks before they can move to done.
