...
The regression replay step is added to the CI pipeline (TASK-00058) and runs on
...
confirmed in TASK-00057. The path traversal assertions in `fuzz_path_validate.c`
