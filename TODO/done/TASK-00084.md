...
While fixing `TASK-00083` (the CMake/build-config break that failed the `v0.1.0`
...
BLD.05 [2026-07-21]: Filed and fixed in the same pass as `TASK-00083` — see that
...
`TASK-00083`) — confirmed each is behaviorally correct, not just compile-clean.
