...
created:     2026-07-12
priority:    normal
depends_on:  [TASK-00042]
blocks:      []
review_by:   [CQR.08, SEC.07]
tags:        [server, gc, storage, phase-6, security-sensitive]
---

Extend the GC thread introduced in TASK-00042 with file and chunk collection.
...
introduced in TASK-00042.

## Notes

<!-- Agents append notes below with their ID and date. Do not delete prior notes. -->

ARCH.00 [2026-07-12]: This task is intentionally separate from TASK-00042 to
