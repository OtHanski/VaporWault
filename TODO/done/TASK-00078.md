...
reviewing TASK-00075's brute-force lockout implementation.
...
ARCH.00 [2026-07-19]: Filed from SEC.07/CQR.08's TASK-00075 review
...
all pre-existing `unit_vw_auth` assertions (including the TASK-00075 lockout
tests) still pass unmodified, plus the new TASK-00079 time-injection tests
